...
Use the [heroku-buildpack-conda](https://github.com/pedrocarmona/heroku-buildpack-conda):
```
$ heroku buildpacks:set https://github.com/pedrocarmona/heroku-buildpack-conda.git -a <your_app>
```
